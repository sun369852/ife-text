...
//			barStr += "<li><a href='#school=" + dataIndex.school + "%unit=" + i + "%bar=" + y + "'>" + item.barName + "</a></li>";
			barStr +="<li class='link'><a href='#school=" + schoolindex + "%unit=" + i + "%bar=" + y + "'>" + item.barName + "</a></li>"
		})
...
function scrollChange(id){
	...
	$h2s.each(function(i,item){
		if(item.offsetHeight > scrollTop){
			if(!last) last = item;
			break;
		}else {
			last = item;
